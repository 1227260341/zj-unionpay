...
import com.zj.data.util.DemoBase;
import com.zj.data.util.sdk.union.AcpService;
import com.zj.data.util.sdk.union.LogUtil;
...
//		String txnTime = req.getParameter("txnTime");
		String merId = "777290058164313";//商户号
		String txnAmt = "1"; //交易金额，单位分，不要带小数点
		String orderId = "413126545647489786465465";//订单id
		String txnTime = req.getParameter("txnTime");//订单发送时间，取系统时间，格式为YYYYMMDDhhmmss，必须取当前时间，否则会报txnTime无效
